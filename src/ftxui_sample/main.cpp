...
// configuration step. It creates a namespace called `Jaxie`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", Jaxie::cmake::project_name, Jaxie::cmake::project_version) };
